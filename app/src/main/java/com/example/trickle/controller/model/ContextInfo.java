...
public class ContextInfo {
    ...
    public ActivityInfo getActivity() { return activity; }

    public void setActivity(ActivityInfo activity) { this.activity = activity; }
    ...
    public void setDisplay(DisplayInfo display) { this.display = display; }

    public NetworkInfo getConnectivity() { return connectivity; }
